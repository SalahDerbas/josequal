<body style="background-image: url({{asset('assets/img/Logo.png')}});background-repeat: no-repeat;background-position: bottom right;background-size: 195px;  background-attachment: fixed;">
<div>
...
<div class="text" style="margin-top: -60px;">
    <h1>500 {{ trans('trans.Internal_Server_Error') }} </h1>
    <h3>{{ trans('trans.Internal_Server_Error') }} - {{ trans('trans.lets_take_you') }} <a href="/home">{{ trans('trans.Go_To_Home') }}</a></h3>
    <strong> <a href="https://nextstagejo.com/"  target="_blank">  <img src="{{asset('assets/img/Logo.png')}}" alt="Logo"  style="opacity: .8; width:18px;height:18px; margin-left: 18px;">   {{trans('trans.Next_Stage_Company')}}</a></strong>
</div>
</body>
<style>
