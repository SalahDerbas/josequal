                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">{{trans('trans.Role_Dashboard')}}</h3>
                        </div>
                        <!-- /.card-header -->
                        @if ($errors->any())
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form action="{{ route('Roles.update', 'test') }}" enctype="multipart/form-data" method="post">
                                                        ...
                                                        <div class="row" >
                                                            <label for="firstname" class="mr-sm-2">{{trans('trans.Permissions')}}
                                                                :</label>
                                                            <br>
                                                            <div class="row">
                                                                <?php
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('Roles.destroy', 'test') }}" method="post">
                                                        {{ method_field('Delete') }}
                                                        @csrf
                                                        {{trans('trans.Are_you_sure_delete')}} <span style="    font-weight: bolder;"> [ {{ $role->name }} ] </span> ?
